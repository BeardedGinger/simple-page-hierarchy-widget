...
# main config
PLUGINSLUG="simple-page-hierarchy-widget"
CURRENTDIR=`pwd`
MAINFILE="simple-page-hierarchy-widget.php" # this should be the name of your main php file in the wordpress plugin
